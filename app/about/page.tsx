  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="mx-auto flex max-w-[1280px] flex-col gap-8 px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
        <section className="grid gap-6 rounded-[2.25rem] bg-white p-6 shadow-[0_24px_70px_rgba(93,64,43,0.08)] lg:grid-cols-[minmax(0,1.1fr)_320px] lg:p-10">
          <div>
          ...
          <div className="rounded-[1.75rem] bg-[var(--panel)] p-6">
        ...
        <section className="grid gap-5 md:grid-cols-3">
          {VALUES.map((value) => (
            <article key={value.title} className="rounded-[1.75rem] bg-[var(--panel)] p-6">
              <h2
